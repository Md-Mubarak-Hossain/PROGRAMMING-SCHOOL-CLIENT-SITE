                        ...
                        <div className="card-actions  lg:justify-end w-full">
                            {
                                <div className='lg:flex w-full mx-auto'>
                                    ...
                                    <div className="card lg:w-80 p-2 m-3  bg-success text-secondary shadow-xl mx-auto">
                                        <div className="card-body">
                                    ...
                                    <div className="card lg:w-80 p-2 m-3  bg-warning text-primary shadow-xl mx-auto">
                                    ...
                                    <div className="card lg:w-80 p-2 m-3  bg-primary text-primary-content mx-auto">
                                        <div className="card-body">
